...
<?
    ...
    else
    {
        ...
        $SQLquery = "INSERT INTO catalogue (song, year, label, new_releases, on_sell_price,release_data, price, artists, img) VALUES ('".$song."', '".$year."', '".$label."','".$new_release."', '".on_sell_price."', '".$release_data."', '".$price."', '".$artists."', '".$img."');";
